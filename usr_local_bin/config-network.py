...
class Wizard:
    ...
    def __init__(self):
        ...
        self.box_image = '/usr/share/icons/hicolor/32x32/apps/nm-device-wired.png'
        self.box_label = 'GNOME Network Manager (Ethernet and WiFi)'
        self.box = self.wizard_option (self.box_image, self.box_label, self.network_manager)
    ...
    def network_manager (self, widget, callback_data=None):
